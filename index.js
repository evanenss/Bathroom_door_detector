...
const invocationName = "bathroom door";
...
const DoorOpen_Handler =  {
    canHandle(handlerInput) {
        const request = handlerInput.requestEnvelope.request;
        return request.type === 'IntentRequest' && request.intent.name === 'DoorOpen' ;
    },
...
const LaunchRequest_Handler =  {
    ...
    handle(handlerInput) {
        ...
        let say = "Check to see if the batroom door is open";
